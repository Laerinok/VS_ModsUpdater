...
set VS_ModsUpdaterPath=E:\Jeux\Vintage Story\Modding\VS_ModsUpdater\_my releases\Windows\VS_ModsUpdater.v.1.3.5
rem Mods directory path:
set modspath=C:\Users\USERNAME\AppData\Roaming\VintagestoryData\Mods
